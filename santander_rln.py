...
with tf.Session() as sess:
    ...
    for i in range(EPOCHS):
        ...
        for j in range(len(idxs)):
            ...
            loss_value, accuracy_value = sess.run([loss, accuracy], feed_dict={x: x_train[idxs[j]], y: y_train[idxs[j]]})
        ...
        pred = []
        for j in range(len(idxs)):
            loss_value, accuracy_value, p = sess.run([loss, accuracy, predicted], feed_dict={x: x_test[idxs[j]], y: y_test[idxs[j]]})
